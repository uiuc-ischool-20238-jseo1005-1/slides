---
title: "Accessible Data Visualization in a Reproducible Way"
author: "JooYoung Seo"
...
- Reproducible + accessible data viz in DS workflow.

---

# Prerequisites...

- Some experience with [R programming language](https://cran.r-project.org/).

- Some background knowledge in [Pandoc Markdown](https://pandoc.org/MANUAL.html).
...
- [MAIDR: Multimodal Access and Interactive Data Representation](https://uiuc-ischool-accessible-computing-lab.github.io/MAIDR/).

- Funded by the Wallace Foundation and ISLS.
